...
This contributor guide describes the current implementation as of September 6, 2026, based on `origin/main` commit `27769d4fb0d4399ed239f0a2f607c0c1adf1ed57`.
...
The client, text-transform foundations, current components, MCP App, named-host acceptance, and Linker demonstration are already delivered. New component slices still need concrete consumers; they do not justify restoring the superseded generalized model or hidden client policies.
