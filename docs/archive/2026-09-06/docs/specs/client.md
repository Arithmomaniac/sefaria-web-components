...
Generation applies the overlay and extracts the six Core operations into a temporary corrected OpenAPI document. That temporary document is the only input for TypeScript and Zod generation.
